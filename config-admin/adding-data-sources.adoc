...
. Weitere Informationen zur Konfiguration oder zur erweiterten Konfiguration, die für Ihre spezifische Datenquelle erforderlich oder verfügbar sind, finden Sie im link:vendor-specific-data-source-reference.md#["Herstellerspezifische Datenquelle"].
